...
\lstinputlisting[basicstyle=\tiny, language=bash, firstline=10, lastline=35]{script.sh}


En casa de tener usuario lo comprobamos si no cogemos todos los usuarios de /etc/passwd

\lstinputlisting[basicstyle=\tiny, language=bash, firstline=37, lastline=49]{script.sh}
...
\lstinputlisting[basicstyle=\tiny, language=bash, firstline=51, lastline=67]{script.sh}
...
\lstinputlisting[basicstyle=\tiny, language=bash, firstline=69, lastline=91]{script.sh}
...
\subsection{script}
\lstinputlisting[basicstyle=\tiny, language=bash, caption=sricpt.sh full code]{script.sh}
\end{document}